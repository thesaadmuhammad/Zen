        ...
        <View style={styles.body}>
            <View style={styles.silderView}>
                ...
                <View style={{flexDirection:"row"}}>
                  <Text style={{fontSize:25 ,marginTop:5,color:"black"}}>{"1"}</Text>
                <Slider
                  style={styles.slider}
                  minimumValue={0}
                  maximumValue={10}
                ...
                />
                <Text style={{fontSize:25 ,marginTop:5,color:"black"}}>{"10"}</Text>
                </View>    
            </View>
            <View style={styles.silderView}>
            ...
            <View>
              <Text style={{marginTop:"60%", fontSize:18, color:"black" }}>{"SAD Coins = Anxious level - Ideal level"}</Text>
            </View>
